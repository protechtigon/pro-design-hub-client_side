                            ...
                            <div className="col-sm-12">
                                <Slider {...Slider2} className="slide-2 testimonial-slider no-arrow">
                                    <div>
                                        <div className="media">
                                            <div className="text-center">
                                                <img src={"/assets/images/about/usman.jpg"} alt="#" />
                                                <h5>Usman Shah</h5>
                                    ...
                                    <div>
                                        <div className="media">
                                            <div className="text-center">
                                                <img src={"/assets/images/about/ismail.jpg"} alt="#" />
                                    ...
                                    <div>
                                        <div className="media">
                                            <div className="text-center">
                                                <img src={"/assets/images/about/ahmed.jpg"} alt="#" />
                                                <h5>Ahmed Mehar</h5>
                                                <h6>Designer</h6>
                                            </div>
                                            <div className="media-body">
                                    ...
                                    <div>
                                        <div className="media">
                                            <div className="text-center">
                                                <img src={"/assets/images/about/marri.jpg"} alt="#" />
