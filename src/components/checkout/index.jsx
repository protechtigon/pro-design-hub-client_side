  ...
  render() {
    ...
    return (
      <div>
        {/*SEO Support*/}
        <Helmet>
          <title>prohub | CheckOut Page</title>
          <meta
            name="description"
            content="prohub – Multipurpose eCommerce React Template is a multi-use React template. It is designed to go well with multi-purpose websites. prohub Bootstrap 4 Template will help you run multiple businesses."
          />
        </Helmet>
        {/*SEO Support End */}
